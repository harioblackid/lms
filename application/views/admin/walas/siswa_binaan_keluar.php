    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h5>DATA SISWA BINAAN YANG KELUAR </h5> <!-- <button class="btn btn-primary" onclick="pilihform('tambah')" data-toggle="modal" data-target="#tambahsiswa"><i class="fas fa-fw fa-plus"></i> Tambah siswa</button> -->
            </div>
            <!-- /.card-header -->
            <div class="card-body">
