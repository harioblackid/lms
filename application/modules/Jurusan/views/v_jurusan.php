        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <button class="btn btn-primary" onclick="pilihform('tambah')" data-toggle="modal" data-target="#tambahjurusan"><i class="fas fa-fw fa-plus"></i> Tambah</button>
                </div>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered table-sm" id="tablejurusan" width="100%" cellspacing="0">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>ID Jurusan</th>
...
<script type="text/javascript">
    ...
    $('#tablejurusan').on('click', '.edit', function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                $("[name='id']").val(data[0].id_jurusan);
                $("[name='nama']").val(data[0].nama_jurusan);
            }
        });
