                ...
                <div class="row align-items-center">
                    <div class="col-xl-6 col-lg-7 col-md-8">
                        <div class="hero__caption">
                            <span data-animation="fadeInLeft" data-delay=".2s">Selamat datang di</span>
                            <h1 data-animation="fadeInLeft" data-delay=".4s">PEMBELAJARAN ONLINE <?= $setting['nama_sekolah'] ?>!</h1>
                            <!-- Hero-btn -->
                            <div class="hero__btn">
                                <a href="<?= base_url('Login') ?>" class="btn hero-btn" data-animation="fadeInLeft" data-delay=".8s">Login Sekarang</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-5">
                        <div class="hero-man d-none d-lg-block f-right" data-animation="jello" data-delay=".4s">
                            <img src="<?= base_url() ?>assets/web/img/hero/heroman.png" alt="" style="width: 120%;">
                        </div>
                    </div>
                </div>
            </div>
...
<!--? Count Down Start -->
<div class="count-down-area pt-90 pb-60 section-bg" data-background="<?= base_url() ?>assets/web/img/gallery/section_bg01.png">
    <div class="container">
                    ...
                    <div class="row justify-content-between">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            ...
                            <div class="single-counter text-center">
                                ...
                                <span class="counter color-blue"><?= $this->db->get('guru')->num_rows() ?></span>
                                <p class="color-blue">+ Guru Pengajar</p>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <!-- Counter Up -->
                            <div class="single-counter text-center">
                                ...
                                <span class="counter color-green"><?= $this->db->get('materi')->num_rows() ?></span>
                                <p class="color-green">+ Materi</p>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <!-- Counter Up -->
                            <div class="single-counter text-center">
                                ...
                                <span class="counter color-red"><?= $this->db->get('siswa')->num_rows() ?></span>
                                <p class="color-red">+ Siswa</p>
                            </div>
                        </div>
                    </div>
                </div>
